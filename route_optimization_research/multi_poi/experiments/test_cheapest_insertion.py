...
def validate_route(
    ...
    - all consecutive legs reachable
    - reported distance equals matrix distance
    """
...
print("=" * 70)
print("CHEAPEST INSERTION CORRECTNESS TEST")
print("=" * 70)
...
print()
print("=" * 70)
print("CHEAPEST INSERTION TEST SUMMARY")
print("=" * 70)
