...
from route_optimization_research.multi_poi.algorithms.three_opt import (
    three_opt,
)
...
if failed == 0:
    ...
    print()
    print(
        "ALL 3-OPT CORRECTNESS TESTS PASSED"
    )
